        ...
        {gateLoading ? (
          ...
          >
            <div className="access-gate-card" style={{
              ...
              <img src={theme === 'dark' ? '/pp-lockup-paper.webp' : '/pp-lockup-ink.webp'} alt="Peptides Panama Logo" style={{ height: '40px', margin: '0 auto 16px auto', display: 'block', borderRadius: '8px' }} />
