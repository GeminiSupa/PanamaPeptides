    ...
    <div className="lead-lp">
      <header className="lead-header">
        <div className="lead-container lead-header-inner">
          <Link href="/" className="lead-brand" aria-label="Peptides Panama home"><Image src="/pp-lockup-ink.webp" alt="Panama Peptides" width={159} height={32} priority /></Link>
      ...
      <footer className="lead-footer">
        <div className="lead-container lead-footer-grid">
          <div><Link href="/" className="lead-footer-brand" aria-label="Peptides Panama home"><Image src="/pp-lockup-paper.webp" alt="Panama Peptides" width={179} height={36} /></Link><p>{c.footerBlurb}</p></div>
