    ...
    <div className="landing-layout min-h-screen">
      ...
      <header className={`lp-header${scrolled ? ' lp-header--scrolled' : ''}`}>
        <div className="lp-header-inner">
          <Link href="/" className="lp-logo">
            <img src={theme === 'dark' ? '/pp-lockup-paper.webp' : '/pp-lockup-ink.webp'} alt="Peptides Panama" className="logo-img-custom" style={{ maxHeight: '40px', width: 'auto', borderRadius: '8px' }} />
          </Link>
      ...
      <footer className="footer" style={{ marginTop: 0 }}>
        <div className="container">
          <img src="/pp-lockup-paper.webp" alt="Logo" style={{ height: '36px', marginBottom: '16px', opacity: 0.95, borderRadius: '8px' }} />
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
            <strong>Legal Notice:</strong> Products offered by Peptides Panama are intended strictly for laboratory research use only. Not for human or veterinary use.
          </div>
        </div>
      </footer>
    </div>
