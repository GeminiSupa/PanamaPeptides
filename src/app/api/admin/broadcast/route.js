    ...
    const htmlMessage = htmlContent ? clampOutlookButtonSizes(htmlContent) : `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
        <div style="text-align: center; margin-bottom: 24px;">
          <img src="https://www.peptidospty.com/logo.png?v=3" alt="Panama Peptide" width="120" height="120" style="display:block;width:120px;height:120px;margin:0 auto 16px auto;border-radius:12px;">
        </div>
${productImage ? `<div style="text-align: center; margin: 0 0 24px;"><img src="${productImage}" alt="" width="220" style="max-width: 220px; width: 220px; height: auto; border: 0;" /></div>` : ''}
        ...
        <div style="text-align: center; margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0;">
          <a href="https://www.peptidospty.com/catalog" style="display: inline-block; background-color: #059669; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(5, 150, 105, 0.2);">
...
export async function POST(request) {
  ...
  try {
    ...
    const pacingColumns = {
      ...
      // Quiet hours, in panama time. Equal start and end would mean a
