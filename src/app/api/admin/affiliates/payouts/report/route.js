...
export async function GET(request) {
  ...
  try {
    ...
    // Calculate dates in panama Time (UTC-5)
    const CR_OFFSET = -5;
      ...
      try {
        const adminEmailHtml = `
          <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#e2e8f0;background:#0b0f19;max-width:640px;margin:0 auto;padding:32px 24px;border:1px solid rgba(255,255,255,0.08);border-radius:16px;">
            ...
            <div style="text-align:center;margin-bottom:24px;">
              <a href="https://www.peptidospty.com/admin?tab=affiliates" style="display:inline-block;background:#38bdf8;color:#0b0f19;font-weight:bold;padding:12px 24px;border-radius:8px;text-decoration:none;font-size:13px;">
