export const APPROVED_WHATSAPP_AGENT_TEMPLATES = [
  {
    ...
    body: 'Hola {{1}}, confirmamos que hemos recibido tu solicitud de informacion en Peptides Panama. Estaremos en contacto contigo a la brevedad para brindarte asesoria.',
    variables: [
  ...
  },
  {
    ...
    body: 'Bienvenido a Peptides Panama! Explora nuestro catalogo y descubre productos de investigacion premium.',
    variables: [],
  },
  {
    ...
    body: 'Welcome to Peptides Panama! Explore our catalog and discover premium research products.',
    variables: [],
  },
  {
  ...
  },
  {
    ...
    body: "Hi {{1}}! It's been a few days since your Peptides Panama order. We hope your research is going perfectly!\n\nIf you have a moment, we would greatly appreciate a review: {{2}}\n\nThanks!",
    variables: [
      { key: 'customerName', label: 'Name', fallback: 'Customer' },
