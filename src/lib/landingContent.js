...
export const DEFAULT_LANDING_PAGE_SETTINGS = {
  ...
  topBarTextEn: '',
  topBarTextEs: '',
  heroKickerEn: 'PANAMA PEPTIDES',
  heroKickerEs: 'PANAMA PEPTIDES',
  heroTitleEn: 'Premium Research Peptides in Panama',
  heroTitleEs: 'Péptidos de Investigación Premium en Panamá',
  heroSubEn: 'Explore our catalog, review product information, and check availability and delivery options within Panama.',
  heroSubEs: 'Explora nuestro catálogo, revisa la información de productos y verifica opciones de entrega dentro de Panamá.',
  heroTextEn: 'Information about our catalog, product specifications, availability, and delivery within Panama.',
  heroTextEs: 'Información sobre nuestro catálogo, especificaciones de productos, disponibilidad y entrega dentro de Panamá.',
  ...
  heroDropdownOptions: [
    { labelEn: 'Browse Products', labelEs: 'Explorar productos', href: '/catalog' },
  ...
  primaryCtaEn: 'Browse Products',
  primaryCtaEs: 'Explorar Productos',
  secondaryCtaEn: 'Product Information',
  secondaryCtaEs: 'Información del Producto',
  catalogBannerActive: true,
  catalogBannerImageUrl: '/catalog-promo-banner.webp',
  catalogBannerUrl: '/catalog',
  catalogBannerAltEn: 'Panama Peptides product vials',
  catalogBannerAltEs: 'Viales de Panama Peptides',
  pressActive: true,
  ...
  pressItems: [
    {
      ...
      quoteEs: '"la empresa que queríamos que existiera"',
    },
  ],
  differenceTitleEn: 'We Do Things Differently',
  differenceTitleEs: 'Hacemos las cosas diferente',
  differenceTextEn: 'Clear pricing, bulk discounts, direct communication, and reliable local service inside Panama.',
  differenceTextEs: 'Precios claros, descuentos por volumen, comunicación directa y servicio local confiable dentro de Panamá.',
  differenceCards: [
    {
      titleEn: 'No cross-border delays',
      titleEs: 'Sin demoras de aduana',
      textEn: 'Inventory is already in Panama, reducing international shipping uncertainty.',
      textEs: 'El inventario ya está en Panamá, reduciendo la incertidumbre del envío internacional.',
    },
    {
      titleEn: 'Fast, safe online ordering',
      titleEs: 'Órdenes rápidas y seguras',
  ...
  offerCards: [
    ...
    { titleEn: 'Order Delivery', titleEs: 'Entrega de Pedidos', textEn: 'Fast, reliable local delivery inside Panama.', textEs: 'Entrega local rápida y confiable dentro de Panamá.' },
  ...
  audienceItems: [
    ...
    { titleEn: 'Professional Buyers', titleEs: 'Compradores Profesionales', textEn: 'Clear pricing, bulk options, and direct coordination in Panama.', textEs: 'Precios claros, opciones por volumen y coordinación directa en Panamá.' },
  ],
  ...
  proofImageUrl: '/vials_group_panama.png',
  ...
  faqItems: [
    { qEn: 'Do you ship outside Panama?', qEs: '¿Envían fuera de Panamá?', aEn: 'No. We currently serve customers within Panama only.', aEs: 'No. Actualmente servimos solo a clientes dentro de Panamá.' },
    ...
    { qEn: 'What payment methods do you accept?', qEs: '¿Qué métodos de pago aceptan?', aEn: 'We accept Credit/Debit Cards and local transfer (Yappy / ACH / USD).', aEs: 'Aceptamos Tarjetas de Crédito/Débito y transferencia local (Yappy / ACH / USD).' },
  ...
  footerDescriptionEn: 'Panama Peptides offers premium, research-grade peptides with trusted quality and reliable local delivery across Panama.',
  footerDescriptionEs: 'Panama Peptides ofrece péptidos premium de grado investigación con calidad confiable y entrega local segura en Panamá.',
  legalNoticeEn: 'Products offered by Panama Peptides are intended strictly for laboratory research use only. They are not approved or licensed by the FDA for the prevention, diagnosis, treatment, or cure of any disease. Information on this website is for educational purposes only and should not be considered medical or legal advice. Not for human or veterinary use.',
  legalNoticeEs: 'Los productos ofrecidos por Panama Peptides son estrictamente para uso de investigación de laboratorio. No están aprobados para prevenir, diagnosticar, tratar o curar enfermedades. La información de este sitio es educativa y no constituye consejo médico o legal. No apto para uso humano o veterinario.',
  footerQuickLinks: [
...
export const DEFAULT_PUBLIC_PAGE_SETTINGS = {
  page_info_center: {
    ...
    steps: [
      ...
      { titleEn: 'Storage & handling', titleEs: 'Almacenamiento y manejo', textEn: 'Keep products stable in Panama climate.', textEs: 'Mantén productos estables en el clima de Panama.' },
  ...
  page_affiliate_program: {
    ...
    benefits: [
      ...
      { titleEn: 'Reliable local supply', titleEs: 'Suministro local confiable', textEn: 'Products are already coordinated in Panama.', textEs: 'Productos coordinados localmente en Panama.' },
  ...
  page_blog: {
    ...
    heroTextEn: 'Evidence-minded articles, practical guides, and company updates from Panama Peptides.',
    heroTextEs: 'Artículos basados en evidencia, guías prácticas y novedades de Panama Peptides.',
    ...
    articleCtaTextEn: 'Browse transparent product information and current availability in our Panama catalog.',
    articleCtaTextEs: 'Consulta información transparente y disponibilidad actual en nuestro catálogo de Panama.',
    ...
    fallbackPosts: [
      ...
      {
        id: 'fallback-2',
        slug: 'peptide-delivery-panama',
        title_en: 'Peptide delivery in Panama',
        title_es: 'Entrega de péptidos en Panama',
        ...
        image_url: '/vials_group_panama.png',
  ...
  page_about: {
    ...
    heroTextEn: 'Panama Peptides was founded by Joey Webster and Sean McCully. Originally from California, both made Panama their home and built lasting connections through sport and business.',
    heroTextEs: 'Panama Peptides fue fundado por Joey Webster y Sean McCully. Originarios de California, ambos hicieron de Panama su hogar y construyeron conexiones duraderas a través del deporte y los negocios.',
    ...
    startedTextEn: 'We saw an opportunity to make local ordering more straightforward. Panama Peptides was established with a focus on clear product information, transparent pricing, direct communication, and coordinated delivery within Panama.',
    startedTextEs: 'Vimos la oportunidad de hacer que los pedidos locales fueran más sencillos. Panama Peptides se estableció con un enfoque en información clara del producto, precios transparentes, comunicación directa y entrega coordinada dentro de Panama.',
    ...
    aheadTextEn: 'As we grow, our focus remains on accurate information, dependable service, and responsive communication with our customers in Panama.',
    aheadTextEs: 'A medida que crecemos, nuestro enfoque sigue siendo la información precisa, el servicio confiable y la comunicación ágil con nuestros clientes en Panama.',
  ...
  page_faq: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        aEn: 'We accept Yappy (USD) and credit/debit cards (Visa, Mastercard). All payments are handled securely through our encrypted checkout.',
        aEs: 'Aceptamos Yappy (USD) y tarjetas de crédito/débito (Visa, Mastercard). Todos los pagos son procesados de forma segura.',
      },
      {
        qEn: 'How fast is delivery?',
        qEs: '¿Qué tan rápido es el envío?',
        aEn: 'We ship within 24–48 hours of payment confirmation. Delivery to most areas of Panama takes 1–3 business days.',
  ...
  page_service_locations: {
    ...
    heroTextEn: 'We proudly serve customers exclusively within Panama, ensuring fast, reliable, and secure delivery directly to your door.',
    heroTextEs: 'Atendemos con orgullo a clientes exclusivamente dentro de Panama, garantizando entregas rápidas, confiables y seguras directamente en su puerta.',
    ...
    courierTextEn: 'We use trusted local couriers like Uno Express and local couriers to ensure your research peptides arrive safely within 24 to 48 hours, depending on your province.',
    courierTextEs: 'Utilizamos mensajeros locales de confianza como Uno Express y mensajeros locales para garantizar que sus péptidos de investigación lleguen de manera segura dentro de 24 a 48 horas, dependiendo de su provincia.',
  ...
  page_contact: {
    ...
    heroTitleEn: 'Contact Panama Peptides',
    heroTitleEs: 'Contacta Panama Peptides',
    ...
    heroPoints: [
      ...
      { labelEn: 'Local Panama delivery', labelEs: 'Entrega local en Panama' },
